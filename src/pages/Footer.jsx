        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="leading-relaxed">
              Preserving the art of handmade woodcraft since 1998. Each piece
              tells a story of tradition, sustainability, and meticulous
              craftsmanship.
            </p>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a
                  ...
                  className="text-amber-300 hover:text-amber-400 transition-colors"
                >
                  <FaXTwitter className="w-5 h-5 mt-0.5" />{" "}
